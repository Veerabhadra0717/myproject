  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        toast.success("Welcome back to WanderLust Bangalore!")
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        >
          <div className="flex justify-center items-center space-x-2 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gradient">WanderLust</h1>
              <p className="text-sm text-gray-600">From Bangalore</p>
            </div>
          </div>
          <h2 className="text-3xl font-bold text-gray-900">Welcome back!</h2>
          <p className="mt-2 text-sm text-gray-600">Sign in to continue planning your perfect journey from Bangalore</p>
